...
export function Assessments() {
  const data = [{title:'React Final Exam', crs:'Advanced React', pass:'80%', avg:'85%', status:'Active'},{title:'Security Quiz 1', crs:'Info Sec 2026', pass:'100%', avg:'98%', status:'Active'}];
    ...
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Manage quizzes, question banks, and scores</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Assessment Title</th><th className='px-6 py-3'>Course</th><th className='px-6 py-3'>Passing Score</th><th className='px-6 py-3'>Avg Score</th><th className='px-6 py-3'>Status</th>
