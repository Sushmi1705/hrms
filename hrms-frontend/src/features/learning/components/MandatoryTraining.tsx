...
export function MandatoryTraining() {
  const data = [{name:'Data Privacy & GDPR', due:'2026-12-31', comp:'92%', nc:'18 Employees', status:'Active'},{name:'Anti-Money Laundering', due:'2026-10-15', comp:'100%', nc:'0 Employees', status:'Completed'}];

  return (
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          <CardTitle className="text-lg font-semibold text-slate-800">Compliance & Mandatory Training</CardTitle>
          <p className="text-sm text-slate-500 mt-1">Track compliance training completion rates</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Training Name</th><th className='px-6 py-3'>Deadline</th><th className='px-6 py-3'>Completion Rate</th><th className='px-6 py-3'>Non-Compliant</th><th className='px-6 py-3'>Status</th>
