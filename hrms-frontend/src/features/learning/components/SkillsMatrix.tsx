...
export function SkillsMatrix() {
  const data = [{name:'Sarah Jenkins', pskill:'React.js', lvl:'Expert', sskill:'Node.js', status:'Active'},{name:'Michael Chen', pskill:'Product Strategy', lvl:'Intermediate', sskill:'Agile', status:'Active'}];

  return (
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          <CardTitle className="text-lg font-semibold text-slate-800">Organizational Skills Matrix</CardTitle>
          <p className="text-sm text-slate-500 mt-1">Analyze workforce competencies and skill gaps</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Employee Name</th><th className='px-6 py-3'>Primary Skill</th><th className='px-6 py-3'>Level</th><th className='px-6 py-3'>Secondary Skill</th><th className='px-6 py-3'>Status</th>
