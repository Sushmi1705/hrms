...
export function CourseCatalog() {
  const data = [{title:'Advanced React Patterns', cat:'Technical', dur:'4h 30m', enr:'145', status:'Published'},{title:'Leadership 101', cat:'Soft Skills', dur:'2h 15m', enr:'89', status:'Draft'},{title:'Information Security 2026', cat:'Compliance', dur:'1h 00m', enr:'1024', status:'Published'}];
    ...
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Manage all e-learning and classroom courses</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Course Title</th><th className='px-6 py-3'>Category</th><th className='px-6 py-3'>Duration</th><th className='px-6 py-3'>Enrollments</th><th className='px-6 py-3'>Status</th>
