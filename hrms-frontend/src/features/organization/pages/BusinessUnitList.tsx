...
import { getBusinessUnits, deleteBusinessUnit, BusinessUnitDto } from '../api/BusinessUnitApi';
...
export function BusinessUnitList() {
  ...
  const { data, isLoading, isError } = useQuery({ queryKey: ['BusinessUnits'], queryFn: getBusinessUnits });
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">BusinessUnits</h1>
