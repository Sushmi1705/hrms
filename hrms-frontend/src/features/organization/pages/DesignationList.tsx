...
import { getDesignations, deleteDesignation, DesignationDto } from '../api/DesignationApi';
...
export function DesignationList() {
  ...
  const { data, isLoading, isError } = useQuery({ queryKey: ['Designations'], queryFn: getDesignations });
