...
import { getDepartments, deleteDepartment, DepartmentDto } from '../api/DepartmentApi';
...
export function DepartmentList() {
  ...
  const { data, isLoading, isError } = useQuery({ queryKey: ['Departments'], queryFn: getDepartments });
