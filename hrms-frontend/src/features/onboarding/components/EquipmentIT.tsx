...
export function EquipmentIT() {
  const data = [{name:'Sarah Jenkins', hw:'MacBook Pro 16', email:'Created', sw:'Pending', status:'In Progress'},{name:'John Doe', hw:'ThinkPad X1', email:'Created', sw:'Assigned', status:'Completed'}];
    ...
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Assign laptops, software licenses, and access rights</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Employee</th><th className='px-6 py-3'>Hardware</th><th className='px-6 py-3'>Email Account</th><th className='px-6 py-3'>Software Licenses</th><th className='px-6 py-3'>Status</th>
