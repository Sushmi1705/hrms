...
export function Probation() {
  const data = [{name:'Chris Evans', date:'2026-06-01', t30:'Completed', t90:'Pending', status:'In Progress'},{name:'Mark Ruffalo', date:'2026-04-01', t30:'Completed', t90:'Completed', status:'Approved'}];

  return (
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          <CardTitle className="text-lg font-semibold text-slate-800">Probation Tracking</CardTitle>
          <p className="text-sm text-slate-500 mt-1">Monitor 30-60-90 day check-ins and confirmations</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Employee</th><th className='px-6 py-3'>Joining Date</th><th className='px-6 py-3'>30-Day Check-in</th><th className='px-6 py-3'>90-Day Review</th><th className='px-6 py-3'>Status</th>
