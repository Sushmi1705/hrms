...
export function Documents() {
  const data = [{name:'Sarah Jenkins', id:'Verified', address:'Pending', tax:'Verified', status:'In Progress'},{name:'Amanda Fox', id:'Verified', address:'Verified', tax:'Verified', status:'Completed'}];

  return (
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          <CardTitle className="text-lg font-semibold text-slate-800">Document Verification</CardTitle>
          <p className="text-sm text-slate-500 mt-1">Review and approve submitted KYC documents</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Employee</th><th className='px-6 py-3'>ID Proof</th><th className='px-6 py-3'>Address Proof</th><th className='px-6 py-3'>Tax Forms</th><th className='px-6 py-3'>Status</th>
