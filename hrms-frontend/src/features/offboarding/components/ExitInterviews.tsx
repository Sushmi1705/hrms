...
export function ExitInterviews() {
  const data = [{name:'Alex Turner', int:'HR Partner', date:'2026-09-10', score:'N/A', status:'Pending'},{name:'Scarlett Johansson', int:'HR Director', date:'2026-08-20', score:'8/10', status:'Completed'}];
    ...
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Schedule and track exit feedback sessions</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Employee</th><th className='px-6 py-3'>Interviewer</th><th className='px-6 py-3'>Scheduled Date</th><th className='px-6 py-3'>Feedback Score</th><th className='px-6 py-3'>Status</th>
