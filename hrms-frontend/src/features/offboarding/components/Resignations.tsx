...
export function Resignations() {
  const data = [{name:'Alex Turner', dept:'Sales', date:'2026-08-15', lwd:'2026-09-15', status:'Approved'},{name:'Lily Collins', dept:'Marketing', date:'2026-08-25', lwd:'2026-09-25', status:'Pending'}];
    ...
    <Card className="shadow-sm border-slate-200">
      <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Manage resignation requests and approvals</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
              <tr>
<th className='px-6 py-3'>Employee</th><th className='px-6 py-3'>Department</th><th className='px-6 py-3'>Resignation Date</th><th className='px-6 py-3'>Last Working Day</th><th className='px-6 py-3'>Status</th>
